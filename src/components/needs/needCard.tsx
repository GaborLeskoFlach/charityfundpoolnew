...
interface INeedCard{
    ...
    onClickArchive : (need : IOrgNeedHelpWithListItem, e : any) => void
    onClickDonate : (need : IOrgNeedHelpWithListItem, e : any) => void
    onClickEdit : (need : IOrgNeedHelpWithListItem, e : any) => void
}
